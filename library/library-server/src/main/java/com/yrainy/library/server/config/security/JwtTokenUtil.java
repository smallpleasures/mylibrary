...
public class JwtTokenUtil {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (userDetails instanceof Admin) {
            claims.put(CLAIM_KEY_ADMIN, "admin");
        } else {
            claims.put(CLAIM_KEY_ADMIN, "notAdmin");
        }
     ...
     * @return
     */
    public String getClaimKeyAdmin(String token) {
        Claims claims = getClaimsFromToken(token);
        String value = (String) claims.get(CLAIM_KEY_ADMIN);
        return value;
    }
