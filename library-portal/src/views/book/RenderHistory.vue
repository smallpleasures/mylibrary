      ...
      <div style="display: flex;justify-content: flex-start;">
        <div style="margin-top: 10px;">
          ...
          <el-input style="width: 300px;margin-right: 20px;"
                    prefix-icon="el-icon-search"
                    v-model="searchValue.readerName"
...
export default {
  ...
  methods: {
    ...
    initLendInfo() {
      ...
      // 30-11 定义高级搜索 url
      let url = '/lendInfo/?currentPage=' + this.currentPage + '&size=' + this.size

        if (this.searchValue.bookName) {
          url += '&bookName=' + this.searchValue.bookName
        }
        if (this.searchValue.readerName) {
          url += '&readerName=' + this.searchValue.readerName
        }
